...
const FlightCreationBlock = ({
  ...
  const createFlight = async (flightData) => {
    const { flightNumber, fromAirport, toAirport, company, duration, plane } =
      flightData;
    ...
    <div className="flightCreationBlock">
      <div className="flightCreationBlock_flightNumber">
        ...
        <input
          ...
          onChange={(e) => setFlightNumber(parseInt(e.target.value))}
        />
      </div>
      <div className="flightCreationBlock_fromAirport">
        ...
        <input
          ...
          onChange={(e) => setFromAirport(parseInt(e.target.value))}
        />
      </div>
      <div className="flightCreationBlock_toAirport">
        ...
        <input
          ...
          onChange={(e) => setToAirport(parseInt(e.target.value))}
        />
      </div>
      ...
      <div className="flightCreationBlock_buttonContainer">
        <button
          ...
          className="flightCreationBlock__createButton"
        >
          Create Flight
        </button>
        <button
          onClick={toggleCreationBlock}
          className="flightCreationBlock__cancelButton"
        >
          Cancel
        </button>
      </div>
